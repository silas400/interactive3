...
function nextButtonClicked(){
  ...
  else if (currentLesson.classList.contains("1_answer")){
    var script = document.createElement('script');
  ...
  else if (currentLesson.classList.contains("multi_drags_multi_answer")){
    var script = document.createElement('script');
  ...
  else if (currentLesson.classList.contains("codeRun")){
    var script = document.createElement('script');
